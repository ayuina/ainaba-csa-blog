...
SLA 違反に関しては対応が明確に事前定義されている（はず）ですし、契約違反を起こしているわけですが、関係者全員が最優先で対応しなければならない緊急事態なので、ある意味ではわかりやすい状況です。
...
こうなると現実的には「塩漬け」などと呼ばれる方針が取られ、時間経過に伴って技術的負債が増えていくことにもなりかねません。
...
大事なのはエンドユーザーとサービスプロバイダーの間で「同意」をすることです。
...
- ご自身が提供するサービスの SLA 設定は十分に注意しましょう（明確にしておかなければ書いてないことまで要求されかねません）
